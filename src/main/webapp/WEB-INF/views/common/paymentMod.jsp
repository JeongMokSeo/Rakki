			...
			<div class="content_area">
				<div class="content_main">
					<div class="content_title">
						<div class="title">
							<h3 class="title_h3">결제 정보 (카드수정)</h3>
					...
					<div class="my_list">
						<form method="post" name="Frm" >
							...
							<div class="basic" style="width: 700px;" >
								...
								<input type="text"class="input" id="account_num" name="account_num" value="${payment.account_num }"   />
								<div class="line-box">
									<div class="line"></div>
								</div>
								
								<label for ="credit_num"><p class="label-txt">카드번호</p></label>
								<input type="text" class="input" id="credit_num" name="credit_num" value="${payment.credit_num }"   />
								<div class="line-box">
									<div class="line"></div>
								</div>

								<input class="btn btn-primary sm" id ="btnUpd" type="button"  value="수정하기" />
							</div>
						</Form>
					</div>
