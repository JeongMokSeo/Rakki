        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Notice Modify Page</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Notice Modify Page</h6>
                        </div>
                        <div class="card-body">
                        	<form method="post">
	                        	<div class="form-group">
		                            <label for="nno" class="text-dark font-weight-bold">번호</label>
		                        	<input class="form-control" id="nno" name="nno" readonly value="${notice.nno}">
	                        	</div>
	                        	<div class="form-group">
	                        	...
	                        	<div class="form-group">
		                        	...
		                        	<textarea rows="10" class="form-control" id="content" name="content" >${notice.content}</textarea>
	                        	</div>
	                        	...
	                        	<div style="margin-left: 250px">
		                        	<button class="btn btn-outline-warning"  formaction="mNoticeModify" id="btnSubmit" style="width:150px;  border-radius: 8px;">Modify</button>
		                        	<button class="btn btn-outline-danger" id="btnRM" formaction="remove"  style="width:150px;  border-radius: 8px;">Remove</button>
		                        	<a class="btn btn-outline-dark" href="mNoticeList1" style="width:150px; border-radius: 8px;">List</a>
                        		</div>
                        		<sec:csrfInput/>
                        	</form>
                        </div>
