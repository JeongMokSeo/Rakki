                            ...
                            <div class="card shadow mb-4" style="margin: 15px; height: 60%">
                               <!-- Card Header - Dropdown -->
                                <div 
                            		...
                            		<h4 style="font-weight: bold; margin-top: 5px; margin-left: 30px"> >> 구매상태체크</h4>
                            	</div>
								...
								<form id="frm_search" method="post">
									<table class="wp-table">
									    ...
									    <tr>
									    	...
									    	<td>
												<select name="buyStatus" id="buyStatus" class="custom-select custom-select-sm form-control form-control-sm mr-3">
