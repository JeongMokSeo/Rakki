...
<jsp:include page="../includes/header.jsp"/>      
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div class="content">
			...
			<!-- Page Heading -->
			<h1 class="h3 mb-2 text-gray-800">판매하기</h1>
			<div class="before">
									...
									<li class="select_item">
										<a class="select_link" data-size="${price[0]}" data-price="${price[1]}">
											<div class="link_inner">
												...
												<c:if test="${ not empty price[1]}"><span class="price_green"><fmt:formatNumber value="${price[1]}" pattern="#,###" /></span></c:if><c:if test="${ empty price[1]}"><span class="price">판매입찰</span></c:if>							
											</div>
										</a>
									</li>
								</c:forEach>						
...
$(function() {
	$(".select_item").on("click","a",function() {	
		...
		//$(".myCard").css({'background-color' : '#41b979', 'color' : 'white'});
    })
