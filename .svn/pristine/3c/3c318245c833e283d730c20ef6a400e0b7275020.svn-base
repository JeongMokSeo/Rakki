        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
	            ...
	            <!-- End of Topbar -->
                            ...
                            <div class="card shadow mb-4" style="margin: 15px; height: 92%">
                               <!-- Card Header - Dropdown -->
								...
								<form id="frm_search" method="post">
									<table class="wp-table" style="width: 600px; margin-left: 185px">
										...
										<div id="chart" style="width: 85%; height: 30%; margin-left: 80px">
										...
										<table id="dataTableD">
											...
											<c:forEach items="${month}" var="month">
												<tr>
													<td style="text-align: center;"><c:out value="${month.MONTH}" />월</td>
													<td style="text-align: center;"><fmt:formatNumber type="number" value="${month.INCOME}"/>원</td>
												</tr>									
											</c:forEach>						
		                                	</tbody>
		                                </table>
